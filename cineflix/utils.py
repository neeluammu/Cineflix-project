...
def get_recommended_movies(movie):
    ...
    data.drop(columns=['description','industry__name','certification','artists__name','genre__name','tags'],inplace=True)
    ...
    recommended_movie = Movie.objects.filter(id__in=recommended_movies_ids)
